...
class Employee{
   ...
   private long salary;
    ...
    public boolean equals(Object obj){
        if (this == obj)// two object point to the same address
            return true;
        if (obj == null)
            return false;
        ...
        Employee other = (Employee) obj; // cast from object type to Employee type
        return (this.getId() == other.getId()); // use Id to compare since hashCode is generated by Id
